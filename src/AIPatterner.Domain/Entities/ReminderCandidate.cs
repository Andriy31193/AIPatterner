...
public class ReminderCandidate
{
    ...
    /// <summary>
    /// List of user prompts associated with this reminder.
    ...
    /// <summary>
    /// Reschedules the reminder for the next occurrence (for recurring reminders).
    /// This should be called after MarkAsExecuted to reschedule based on the occurrence pattern.
    /// Changes status back to Scheduled and updates CheckAtUtc, while keeping ExecutedAtUtc and Decision for history.
    /// </summary>
    public void RescheduleForNextOccurrence(DateTime nextExecutionTime)
    {
        CheckAtUtc = nextExecutionTime;
        Status = ReminderCandidateStatus.Scheduled; // Change back to Scheduled for recurring reminders
        // Note: ExecutedAtUtc and Decision are kept to track the last execution
    }
...
/// <summary>
/// Represents a user prompt entry in a reminder's userPromptsList.
/// </summary>
